...
export const MATERIAL_META: Readonly<Record<MaterialType, MaterialMeta>> = {
  ...
  [MaterialType.ICE]:          { name: 'Ice',          density: 0.9,  baseColor: [173, 216, 230], flammable: false, ignitionTemp: Infinity },
  ...
  [MaterialType.SNOW]:         { name: 'Snow',         density: 0.9,  baseColor: [230, 240, 255], flammable: false, ignitionTemp: Infinity },
